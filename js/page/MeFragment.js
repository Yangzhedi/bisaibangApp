        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.list}>
                    ...
                    <Item icon="md-eye" text="hujianqu真帅" subText="15篇" onPress={this._onPressCallback.bind(this, 3)}/>
                    <Item icon="md-pricetag" text="hujianquhgkhjh真帅" subText="9个" onPress={this._onPressCallback.bind(this, 4)}/>
                    <Item icon="md-pricetag" text="hujianqu真帅" subText="9个" onPress={this._onPressCallback.bind(this, 4)}/>
                </View>
                <View style={styles.list}>
                    <Item icon="md-bug" text="掘金排名" iconColor="#ff4500" onPress={this._onPressCallback.bind(this, 5)}/>
            ...
            return(
                <TouchableNativeFeedback onPress={onPress}>
                    <View style={styles.listItem}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end'}}>
                            <Text style={{color: "#ccc"}}>{subText+'123'}</Text>
                        </View>
                    </View>
                </TouchableNativeFeedback>
            );
